...
- Make a local clone of this repo: `git clone git@github.com:Starcounter/starcounter-debug-aid.git`

In order to develop it locally we suggest to use [polyserve](https://npmjs.com/polyserve) tool to handle bower paths gently.

0. Go to the repo's directory: `cd starcounter-debug-aid`
...
4. Open the demo/preview: [http://localhost:8000/components/starcounter-debug-aid/](http://localhost:8000/components/starcounter-debug-aid/)

## Contributing Pull Requests

1. Fork it! Or work on a branch directly in this repo if you can.
