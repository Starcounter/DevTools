...
<path d="m24 9.965c9.341 0 16.913 7.5 16.913 16.751s-7.572 16.751-16.913 16.751c-9.34 0-16.912-7.5-16.912-16.751s7.572-16.751 16.912-16.751z" fill="#484848"/>
<path d="m8.101 27.638c0-3.038-0.741-2.581 7.981-5.162 6.541-1.914 10.942-2.499 10.942-1.499 0 1.165-2.55 4.287-8.556 10.45-3.332 3.373-6.171 6.12-6.337 6.12-0.163 0-0.698-0.583-1.191-1.29-1.688-2.456-2.839-5.829-2.839-8.619z" fill="#FAB914"/>
<g fill="#F47E20">
...
<path d="m18.386 11.775c1.331-0.775 3.178-0.842 4.67-0.828 0.749 7e-3 1.519 0.053 2.244 0.25 0.294 0.08 0.568 0.191 0.816 0.369 0.202 0.147 0.898 0.669 0.703 1.001-0.289 0.458-3.414 0.458-7.198 0.041-2.181-0.25 3.784 0.417 0 0-2.181-0.25-2.222-0.25-1.235-0.833z"/>
    ...
    <div id="sc-debug-aid" v-bind:class="[isOverlay ? 'sc-debug-aid-in-overlay' : 'sc-debug-aid-in-popup']">
      ...
      <div v-if="usedKeyComb" class="starcounter-debug-aid-key-comb-warning"><p>⚠️ You've opened Starcounter Debug Aid using the key combination, this shortcut is deprecated in favour of the browser action button in the top right corner of your browser window.</p></div>
